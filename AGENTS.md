...
| Ktlint KMP code style | `AI/Skills/ktlint_kmp_code_style` | `SKILL.md` | Reglas que se han de seguir para respetar el KtlintCheck al escribir código para que no se generen cientos de puntos a corregir en cada PullRequest. |
