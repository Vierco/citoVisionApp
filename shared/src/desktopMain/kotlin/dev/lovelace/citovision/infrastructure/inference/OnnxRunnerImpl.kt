...
/**
 * Ejecuta el modelo ONNX en Desktop (JVM) con `ai.onnxruntime` (SPEC-0006, ADR-0003). Comparte la misma API
 * Java que Android; la `OrtSession` se crea una sola vez (perezosa, protegida por Mutex) y se reutiliza. Se
 * lee la primera salida (rama de detección `output0`); los prototipos de máscara se ignoran.
 */
